...
dotnet lambda deploy-serverless --template-parameters "UserEmail=$UserEmail;InputBucketNameSuffix=$InputBucketNameSuffix;OutputBucketNameSuffix=$OutputBucketNameSuffix"
